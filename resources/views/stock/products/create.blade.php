...
@section('title', 'Register New Product - StockManager ERP')

@section('header', 'Register New Product Master')
@section('subheader', 'Create complete product master record with classification, pricing, inventory parameters, and attributes.')
        ...
        <form action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row g-4">
                    ...
                    <div class="card p-4 rounded-4 shadow-sm border-translucent bg-body mb-4">
                        ...
                        <div class="row g-3">
                            <div class="col-12">
                                ...
                                <input type="text" name="name" class="form-control rounded-3 @error('name') is-invalid @enderror" value="{{ old('name') }}" placeholder="e.g. Industrial Steel Bolt M10" required>
                                @error('name') <div class="invalid-feedback">{{ $message }}</div> @enderror
                            </div>
                            <div class="col-12 col-md-6">
                                <label class="form-label fw-semibold">Product Code (System Ref)</label>
                                <input type="text" name="code" class="form-control rounded-3 @error('code') is-invalid @enderror" value="{{ old('code') }}" placeholder="Auto-generated if empty">
                                @error('code') <div class="invalid-feedback">{{ $message }}</div> @enderror
                            </div>
                            <div class="col-12 col-md-6">
                                <label class="form-label fw-semibold">SKU (Stock Keeping Unit)</label>
                                <input type="text" name="sku" class="form-control rounded-3 @error('sku') is-invalid @enderror" value="{{ old('sku') }}" placeholder="Auto-generated if empty">
                                @error('sku') <div class="invalid-feedback">{{ $message }}</div> @enderror
                            </div>
                            <div class="col-12 col-md-6">
                                <label class="form-label fw-semibold">Barcode (EAN / UPC)</label>
                                <input type="text" name="barcode" class="form-control rounded-3 @error('barcode') is-invalid @enderror" value="{{ old('barcode') }}" placeholder="e.g. 8901234567890">
                                @error('barcode') <div class="invalid-feedback">{{ $message }}</div> @enderror
                            </div>
                            <div class="col-12 col-md-6">
                                <label class="form-label fw-semibold">QR Code Identifier</label>
                                <input type="text" name="qr_code" class="form-control rounded-3 @error('qr_code') is-invalid @enderror" value="{{ old('qr_code') }}" placeholder="e.g. QR-PRD-001">
                                @error('qr_code') <div class="invalid-feedback">{{ $message }}</div> @enderror
                            </div>
                            <div class="col-12">
                                <label class="form-label fw-semibold">Product Description</label>
                                <textarea name="description" class="form-control rounded-3" rows="3" placeholder="Detailed product specifications and features...">{{ old('description') }}</textarea>
                            </div>
                            <div class="col-12">
                                ...
                                <div class="row align-items-center g-3">
                                    ...
                                    <div class="col">
                                        ...
                                        <div class="form-text small">Select product image (JPEG, PNG, WEBP - max 2MB).</div>
                    ...
                    <div class="card p-4 rounded-4 shadow-sm border-translucent bg-body mb-4">
                        ...
                        <div class="row g-3">
                            <div class="col-12 col-md-4">
                                ...
                                <input type="number" step="0.01" name="purchase_price" class="form-control rounded-3 @error('purchase_price') is-invalid @enderror" value="{{ old('purchase_price', '0.00') }}" required>
                                @error('purchase_price') <div class="invalid-feedback">{{ $message }}</div> @enderror
                            </div>
                            <div class="col-12 col-md-4">
                                <label class="form-label fw-semibold">Cost Price (WAC ₹) <span class="text-danger">*</span></label>
                                <input type="number" step="0.01" name="cost_price" class="form-control rounded-3 @error('cost_price') is-invalid @enderror" value="{{ old('cost_price', '0.00') }}" required>
                                @error('cost_price') <div class="invalid-feedback">{{ $message }}</div> @enderror
                            </div>
                            <div class="col-12 col-md-4">
                                <label class="form-label fw-semibold">Selling Price (Base ₹) <span class="text-danger">*</span></label>
                                <input type="number" step="0.01" name="selling_price" class="form-control rounded-3 @error('selling_price') is-invalid @enderror" value="{{ old('selling_price', '0.00') }}" required>
                                @error('selling_price') <div class="invalid-feedback">{{ $message }}</div> @enderror
                            </div>
                            <div class="col-12 col-md-3">
                                <label class="form-label fw-semibold">MRP (Maximum Retail)</label>
                                <input type="number" step="0.01" name="mrp" class="form-control rounded-3" value="{{ old('mrp', '0.00') }}">
                            </div>
                            <div class="col-12 col-md-3">
                                <label class="form-label fw-semibold">Dealer Price (₹)</label>
                                <input type="number" step="0.01" name="dealer_price" class="form-control rounded-3" value="{{ old('dealer_price', '0.00') }}">
                            </div>
                            <div class="col-12 col-md-3">
                                <label class="form-label fw-semibold">Wholesale Price (₹)</label>
                                <input type="number" step="0.01" name="wholesale_price" class="form-control rounded-3" value="{{ old('wholesale_price', '0.00') }}">
                            </div>
                            <div class="col-12 col-md-3">
                                <label class="form-label fw-semibold">Min Selling Price (₹)</label>
                                <input type="number" step="0.01" name="min_selling_price" class="form-control rounded-3" value="{{ old('min_selling_price', '0.00') }}">
                            </div>
                        </div>
                    </div>

                    <!-- 3. Storage, Location & Supplier -->
                    <div class="card p-4 rounded-4 shadow-sm border-translucent bg-body mb-4">
                        <h5 class="fw-bold text-body mb-3">3. Storage & Primary Supplier</h5>
                        <div class="row g-3">
                            <div class="col-12 col-md-4">
                                <label class="form-label fw-semibold">Warehouse Location</label>
                                <input type="text" name="warehouse_location" class="form-control rounded-3" value="{{ old('warehouse_location', 'Main Warehouse') }}" placeholder="e.g. Warehouse A">
                            </div>
                            <div class="col-12 col-md-4">
                                <label class="form-label fw-semibold">Rack / Shelf Location</label>
                                <input type="text" name="rack_location" class="form-control rounded-3" value="{{ old('rack_location') }}" placeholder="e.g. Rack R-12">
                            </div>
                            <div class="col-12 col-md-4">
                                <label class="form-label fw-semibold">Storage Condition</label>
                                <input type="text" name="storage_condition" class="form-control rounded-3" value="{{ old('storage_condition') }}" placeholder="e.g. Dry Ambient 25°C">
                            </div>
                            <div class="col-12 col-md-8">
                                <label class="form-label fw-semibold">Primary Supplier Name</label>
                                <input type="text" name="primary_supplier" class="form-control rounded-3" value="{{ old('primary_supplier') }}" placeholder="e.g. Acme Industrial Supplies">
                            </div>
                            <div class="col-12 col-md-4">
                                <label class="form-label fw-semibold">MOQ (Min Order Qty)</label>
                                <input type="number" name="moq" class="form-control rounded-3" value="{{ old('moq', 1) }}" min="1">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card p-4 rounded-4 shadow-sm border-translucent bg-body mb-4">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                @else
                                    <input type="{{ $attr->type === 'number' ? 'number' : 'text' }}" name="attribute_values[{{ $attr->id }}]" class="form-control rounded-3" placeholder="Enter {{ strtolower($attr->name) }}">
                                @endif
                            </div>
                            @endforeach
                        </div>
                ...
                <div class="col-12 col-xl-4">
                    ...
                    <div class="card p-4 rounded-4 shadow-sm border-translucent bg-body mb-4">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="tax_id" class="form-select rounded-3">
                                ...
                                @foreach($taxes as $t)
                                    <option value="{{ $t->id }}" {{ old('tax_id') == $t->id ? 'selected' : '' }}>{{ $t->name }} ({{ $t->rate }}%)</option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <select name="product_type" class="form-select rounded-3">
                                <option value="single" {{ old('product_type') == 'single' ? 'selected' : '' }}>Single Item</option>
                                <option value="variant" {{ old('product_type') == 'variant' ? 'selected' : '' }}>Variant Item</option>
                                <option value="combo" {{ old('product_type') == 'combo' ? 'selected' : '' }}>Combo / Bundle</option>
                            </select>
                        </div>
                    ...
                    <div class="card p-4 rounded-4 shadow-sm border-translucent bg-body mb-4">
                        <h5 class="fw-bold text-body mb-3">Initial Inventory Stock</h5>
                        <div class="mb-3">
                            <label class="form-label fw-semibold">Opening Stock Quantity</label>
                            <input type="number" name="initial_stock" class="form-control rounded-3" value="{{ old('initial_stock', 0) }}" min="0">
                        </div>
                        <div class="mb-3">
                            <label class="form-label fw-semibold">Minimum Safety Stock Level</label>
                            <input type="number" name="min_stock" class="form-control rounded-3" value="{{ old('min_stock', 5) }}" min="0">
                        </div>
                        <div class="mb-3">
                            <label class="form-label fw-semibold">Reorder Threshold Level</label>
                            <input type="number" name="reorder_level" class="form-control rounded-3" value="{{ old('reorder_level', 10) }}" min="0">
                        </div>
                    </div>

                    <!-- Submit Actions -->
                    <div class="card p-4 rounded-4 shadow-sm border-translucent bg-body">
                        <button type="submit" class="btn btn-primary rounded-3 w-100 py-3 fw-bold mb-2">Save & Register Product Master</button>
                        <a href="{{ route('products.index') }}" class="btn btn-outline-secondary rounded-3 w-100 py-2">Cancel</a>
                    </div>
                </div>
            </div>
        </form>
