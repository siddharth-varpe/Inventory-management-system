...
<head>
    ...
    <title>Register - StockManager Enterprise ERP</title>
    ...
    <div class="container p-3">
        <div class="card auth-card mx-auto bg-body p-4 p-sm-5">
            <div class="text-center mb-4">
                ...
                <p class="text-muted small">Create your enterprise user account</p>
            </div>
            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                <!-- Name -->
                <div class="mb-3">
                    <label for="name" class="form-label fw-semibold small text-body">Full Name</label>
                    <input id="name" type="text" class="form-control form-control-lg @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" required autofocus autocomplete="name" placeholder="John Doe">
                    @error('name')
                ...
                <div class="mb-3">
                    ...
                    <input id="email" type="email" class="form-control form-control-lg @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="username" placeholder="name@company.com">
                    @error('email')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <!-- Confirm Password -->
                <div class="mb-4">
                    <label for="password_confirmation" class="form-label fw-semibold small text-body">Confirm Password</label>
            ...
            <div class="text-center mt-4 pt-3 border-top border-translucent">
                ...
                <a href="{{ route('login') }}" class="text-decoration-none fw-semibold small ms-1">Sign In</a>
            </div>
        </div>
    </div>
</body>
