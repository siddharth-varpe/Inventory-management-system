...
<div class="row g-4">
    ...
    <div class="col-12 col-lg-9">
        ...
        <div class="row g-3 mb-4">
            ...
            <div class="col-12 col-sm-6 col-xl-3">
                <a href="{{ route('organize.picking.index') }}" class="text-decoration-none">
                    <div class="card p-3 rounded-4 shadow-sm border-translucent bg-body hover-shadow transition-all">
                        <div class="d-flex align-items-center justify-content-between">
                            <div class="text-muted small fw-semibold">Active Pick Tasks</div>
                            <span class="fs-4">📦</span>
                        </div>
            ...
            <div class="col-12 col-sm-6 col-xl-3">
                <a href="{{ route('organize.dispatch.index') }}" class="text-decoration-none">
                    <div class="card p-3 rounded-4 shadow-sm border-translucent bg-body hover-shadow transition-all">
                        <div class="d-flex align-items-center justify-content-between">
                            <div class="text-muted small fw-semibold">Packing & Dispatch</div>
                            <span class="fs-4">📤</span>
                        </div>
                        <div class="fs-3 fw-bold text-success mt-1">{{ $kpis['pending_dispatch'] }} Ready</div>
                        <span class="text-muted small" style="font-size: 0.75rem;">Awaiting courier handoff</span>
                    </div>
                </a>
            </div>
        ...
        <div class="card p-4 rounded-4 shadow-sm border-translucent bg-body mb-4">
            ...
            <div class="d-flex flex-wrap gap-2">
                ...
                <a href="{{ route('organize.picking.index') }}" class="btn btn-success rounded-3 px-3 fw-bold">📦 Pick & Pack Order Lines</a>
                <a href="{{ route('organize.dispatch.index') }}" class="btn btn-info text-white rounded-3 px-3 fw-bold">📤 Dispatch Manifest</a>
        ...
        <div class="row g-4 mb-4">
            ...
            <div class="col-12 col-xl-6">
                <div class="card p-4 rounded-4 shadow-sm border-translucent bg-body h-100">
                    <div class="d-flex align-items-center justify-content-between mb-3">
                        <h6 class="fw-bold text-body mb-0">Active Picking Tasks</h6>
                        <a href="{{ route('organize.picking.index') }}" class="btn btn-sm btn-link text-decoration-none fw-bold p-0">View All &rarr;</a>
                    </div>
                            ...
                            <table class="table table-hover align-middle mb-0" style="font-size: 0.85rem;">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-end">
                                            <a href="{{ route('organize.picking.index') }}" class="btn btn-xs btn-success rounded-3 px-2 py-1 fw-semibold">Pick Items</a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
