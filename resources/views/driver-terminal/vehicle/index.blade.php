...
<div class="vstack gap-4">
    ...
    <div class="d-flex align-items-center justify-content-between">
        <div class="d-flex align-items-center gap-3">
            ...
            <div>
                ...
                <p class="text-muted small mb-0" style="font-size: 0.8rem;">All assigned vehicle details, 3D WebGL model, health and live status.</p>
            </div>
        </div>
    ...
    <!-- 2. MY VEHICLE CARD WITH INTERACTIVE 3D THREE.JS CANVAS -->
