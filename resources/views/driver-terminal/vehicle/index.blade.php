    ...
    <div class="d-flex align-items-center justify-content-between">
        <div class="d-flex align-items-center gap-3">
            ...
            <div>
                ...
                <p class="text-muted small mb-0" style="font-size: 0.8rem;">Your vehicle details, health and live status.</p>
            </div>
        </div>
    ...
    <div class="card bg-white border border-translucent rounded-4 p-4 shadow-sm">
        ...
        @if($assignedVehicle)
            <div class="row align-items-center g-3 mb-3.5">
                <div class="col-7">
                    ...
                    <div class="text-primary small font-monospace fw-bold mb-0" style="color: #2563eb !important; font-size: 0.82rem;">
                ...
                <div class="col-5 text-end">
                    <img src="{{ asset('images/truck-3d.png') }}" alt="3D Truck Model" 
                         style="max-width: 100%; max-height: 100px; object-fit: contain; filter: drop-shadow(0 6px 12px rgba(0, 0, 0, 0.08));">
                </div>
            </div>
        ...
        @else
            ...
            <div class="text-center py-5">
                <img src="{{ asset('images/truck-3d.png') }}" alt="3D Truck" style="width: 100px; height: 100px; object-fit: contain; opacity: 0.4;">
