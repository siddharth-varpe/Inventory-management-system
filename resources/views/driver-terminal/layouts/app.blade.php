...
<body>
    ...
    <div class="driver-app-shell">
        ...
        <nav class="dt-bottom-nav">
            ...
            <a href="{{ route('driver-terminal.vehicle.status', ['driver_code' => $driverCode]) }}" class="dt-nav-item {{ request()->routeIs('driver-terminal.vehicle.status') || request()->routeIs('driver-terminal.profile') || request()->routeIs('driver-terminal.driver-profile') ? 'active' : '' }}">
                <svg class="dt-nav-icon" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
